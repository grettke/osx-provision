...
*** Manual
:PROPERTIES:
:header-args: :tangle configuration-host-01-manual.org :noweb yes
...
:END:
:PROPERTIES:
:header-args: :tangle configuration-host-02-automated-settings :tangle-mode: (identity #o755)
...
***** Machine
:PROPERTIES:
:ID:       1C9FA62E-7FAC-4D24-943D-5CDC25EE967A
:END:

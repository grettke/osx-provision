...
subset of this document. They live in =provisioning.org= and get tangled to
...
- The *source* document is /weaved/ here and /tangled/ to both SH and ORG files
  meant to be evaluated or performed in numerical order eg ~1..2..3..n~

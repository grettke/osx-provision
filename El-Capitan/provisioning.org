    ...
    - Shortcuts
      ...
      - Keyboard
        - Move focus to next window: Alt-TAB
          - Keep parity with Command-TAB
          - Add SHIFT to cycle to previous window
      - Screen Shots
...
***** GnuPG
:PROPERTIES:
:ID:       org_gcr_2018-08-09T09-29-25-05-00_globigerina:EBC2DD91-E484-4CD0-B999-8D1A2D617576
:END:
#+name: org_gcr_2018-08-09T09-29-25-05-00_globigerina_0757D9F4-A97E-4E3D-9B66-A6EB2E270C3C
#+begin_src sh
brew install gnupg
#+end_src
...
- <2018-01-14 Sun 21:36>
  - Fixed my X startup. Removed a check for non-interactive shells from "doing things".
    turns out that X is a non-interactive shell.
  - Corrected install command: Cask not Brew.
- <2018-02-24 Sat>
  - Be at ease: it takes one or two minutes to start up
...
***** youtube-dl
:PROPERTIES:
:ID:       org_gcr_2017-09-04_mara:A7056C12-8B08-49A1-B8C3-BE02C864A03E
:END:
#+NAME: org_gcr_2017-09-04_mara_A5554AFF-B9FC-4139-945C-A7337F4DB79F
#+BEGIN_SRC sh
...
***** Deluge
:PROPERTIES:
:ID:       org_gcr_2017-10-15_mara:3D744F86-E913-45AC-A3A6-7581A7D63D98
:END:
#+NAME: org_gcr_2017-10-15_mara_56428EA5-AAEE-4E56-9A48-18EB1CE2742E
#+BEGIN_SRC sh
brew cask install deluge
#+END_SRC
***** audio
...
***** Docker
:PROPERTIES:
:ID:       org_gcr_2017-09-07_mara:C3B19B7A-F99A-45D3-932B-ACA319F1AE54
:END:
#+NAME: org_gcr_2017-09-07_mara_9B33A7A7-CC1C-451C-A020-E4B0CFD002F1
#+BEGIN_SRC sh
...
***** Terraform
:PROPERTIES:
:ID:       org_gcr_2018-01-03_mara:BE9C589C-E7E0-4145-A264-5C06FF15F933
:END:
#+NAME: org_gcr_2018-01-03_mara_209AB55E-7801-42AE-87ED-AD2E2AF61C4F
#+BEGIN_SRC sh
brew install terraform
#+END_SRC
***** Ansible
:PROPERTIES:
:ID:       org_gcr_2018-01-03_mara:828088D7-2E3C-4AB6-91A0-FFD959795699
:END:
#+NAME: org_gcr_2018-01-03_mara_51C9C084-72E7-48EC-8E72-9638C180A086
#+BEGIN_SRC sh
...
****** auto-capitalize
:PROPERTIES:
:ID:       org_gcr_2018-06-12T18-03-51-05-00_mara:5C910F70-39E4-44B6-83B4-194EE1ECF55F
:END:
#+name: org_gcr_2018-06-12T18-03-51-05-00_mara_6233CC14-BC22-4938-A490-1E4B50D6198C
#+begin_src sh
cd ~/src
...
***** MySQL
:PROPERTIES:
:ID:       org_gcr_2017-10-23_mara:82D63748-CFAD-42C2-87B0-26EE38C18142
:END:
#+NAME: org_gcr_2017-10-23_mara_BDE68F57-EB90-499A-ADF8-2EEEC572D80E
#+BEGIN_SRC sh
brew install mysql
#+END_SRC

Unlock the root account via [[https://gist.github.com/fallwith/987731][here]].

#+NAME: org_gcr_2017-10-23_mara_E47288C8-656E-4E5C-94F9-973FF271CA0F
...
#+NAME: org_gcr_2017-10-23_mara_1B8DE431-0C29-428B-94DA-58718F0CDF36
#+BEGIN_SRC sql :tangle no
UPDATE mysql.user
...
***** MAMP
:PROPERTIES:
:ID:       org_gcr_2017-10-23_mara:AC6B50EC-F2DA-4886-8375-A0432CBC553E
:END:
#+NAME: org_gcr_2017-10-23_mara_D6B1A43E-FECE-4122-A5D7-D79B923409A0
#+BEGIN_SRC sh
brew cask install mamp
#+END_SRC
***** sequel-pro
:PROPERTIES:
:ID:       org_gcr_2017-10-23_mara:F2F8B08D-FFD6-4557-BF90-FEE01179A8E3
:END:
#+NAME: org_gcr_2017-10-23_mara_EB19B642-F0A4-465A-8AE1-372533560289
#+BEGIN_SRC sh
brew cask install sequel-pro
#+END_SRC
***** make
:PROPERTIES:
:ID:       org_gcr_2018-03-25T00-45-40-05-00_mara:E36BB250-AC54-40F3-979B-CEBF10677EA2
:END:
#+name: org_gcr_2018-03-25T00-45-40-05-00_mara_A28478F1-2909-46E3-9B27-2F0C68FE4C40
#+begin_src sh
...
**** Pulse Messenger
:PROPERTIES:
:ID:       org_gcr_2018-01-25_mara:9376AA6E-6BBF-465B-A6D6-A27376F563A5
:END:
#+NAME: org_gcr_2018-01-25_mara_8E2F6C65-8C83-4C2D-BB90-072429524A4C
#+BEGIN_SRC org
,* Pulse Messenger
...
rm ~/Library/Application\ Support/gramps

...
- VMWare's folder sharing
  - Works perfectly for sharing between two guests, 75% of the time. When it
...
Source it or start a new shell or run this; it is idempotent.
...
From here either use the script which is idempotent or copy and paste.

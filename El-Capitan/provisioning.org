...
- Perform the standard initial setup for =gcr= and don't go any further than that
  configuring things or provisioning anything
- Get updates from AppStore
  - When prompted: Turn on Auto Updates
- Restart and check for more updates
- Shutdown
- Took the snapshot (whle box is off)

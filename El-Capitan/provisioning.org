...
**** Installation
:PROPERTIES:
:header-args: :tangle "_os-x-installation.org"
...
**** Configuration
:PROPERTIES:
:header-args: :tangle "_os-x-configuration.sh" :tangle-mode (identity #o755)
:ID:       46781470-E45C-4E6E-98E9-CD41507FF6FE
:END:
***** Machine
:PROPERTIES:
...
**** Install
:PROPERTIES:
:header-args: :tangle "_administration.sh" :tangle-mode (identity #o755)
...
**** Configure
:PROPERTIES:
:header-args: :tangle "_administration.org"
...
**** Install
:PROPERTIES:
:header-args: :tangle "_usability.sh" :tangle-mode (identity #o755)
...
**** Configure
:PROPERTIES:
:header-args: :tangle "_usability.org"
...
**** Install
:PROPERTIES:
:header-args: :tangle "_utility.sh" :tangle-mode (identity #o755)
...
:END:
#+NAME: A8071E74-A1A0-4AB8-A72C-8E1DF0B2F2B6
#+BEGIN_SRC sh
...
#+NAME: 10A88007-A1AC-4866-A500-C3589478E2E8
#+BEGIN_SRC sh
...
**** Configure
:PROPERTIES:
:header-args: :tangle "_utility.org"
...
**** Install
:PROPERTIES:
:header-args: :tangle "_internet.sh" :tangle-mode (identity #o755)
...
**** Configure
:PROPERTIES:
:header-args: :tangle "_internet.org"
...
**** Install
:PROPERTIES:
:header-args: :tangle "_dev-ops.sh" :tangle-mode (identity #o755)
...
**** Configure
:PROPERTIES:
:header-args: :tangle "_dev-ops.org"
...
**** Install
:PROPERTIES:
:header-args: :tangle "_development.sh" :tangle-mode (identity #o755)
:ID:       F2B0FCF0-1F56-4D3B-AC9F-10F4E430BBE2
:END:
***** Deltawalker
:PROPERTIES:
...
**** Configure
:PROPERTIES:
:header-args: :tangle "_development.org"
...
*** Manual
:PROPERTIES:
:header-args: :tangle "_manual.org"
...
**** Generic
:PROPERTIES:
:header-args: :tangle "_git-generic.sh" :tangle-mode (identity #o755)
...
**** Personal
:PROPERTIES:
:header-args: :tangle "_git-personal.sh" :tangle-mode (identity #o755)
...
**** Install
:PROPERTIES:
:header-args: :tangle "_org-mode.sh" :tangle-mode (identity #o755)
:ID:       F2B0FCF0-1F56-4D3B-AC9F-10F4E430BBE2
:END:
...
**** Install
:PROPERTIES:
:header-args: :tangle "_tex.sh" :tangle-mode (identity #o755)
:ID:       F2B0FCF0-1F56-4D3B-AC9F-10F4E430BBE2
:END:
***** MacTeX
:PROPERTIES:
...
** Testing
:PROPERTIES:
:header-args: :tangle "_testing.org"

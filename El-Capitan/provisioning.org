...
***** PDFpen & PDF Expert
:PROPERTIES:
:ID:       4C5A6665-0927-4513-99AE-4ABD0CAAA75F
:END:

Close call between PDF Expert and PDFpen. For less-techncial who don't need
OCR, the former; for everyone else, the latter.

In either case:
- Only modify PDFs using the same program
  - Going between the two provides poor to horrible results
- Flatted the PDF before sharing it

#+NAME: 16FA1E22-64A5-4DCE-A0CB-3D27C7809243
#+BEGIN_SRC sh
...
:END:
#+NAME: DE3758D9-6E6D-45EC-A208-8C9F65701DC6
#+BEGIN_SRC sh
brew cask install r
#+END_SRC
***** R Studio

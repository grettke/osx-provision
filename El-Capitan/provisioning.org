...
****** GNU Coreutils & More
:PROPERTIES:
:ID:       0DBAF96F-6B96-4E8D-B4A1-23D0B4B816A6
:END:

- Use expected functionality
  - ISO-8601 timestamps primary motivation
- Avoid anything more than the absolute basics because I'm unsure how it could
  affect the OS X build chain
- *Don't use these*
  - They break the OS X Terminal integration
    - Not researching now <2016-01-29 Fri>

#+NAME: 6D1BE63D-F3D1-4259-A0BA-A0656B82F81A
#+BEGIN_SRC sh

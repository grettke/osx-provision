...
- Created a new machine using
  ...
  - Settings
    ...
    - Processors & Memory
      - Processors: 3
      - Memory: 6144MB
        - Tried 7GB for each of the two boxes and 2GB for the host and both
          boxes were slow
      - Advanced options
        - [X] Enable hypervisor
    ...
    - Hard Disk (SATA)
      ...
      - Click "Apply"
- Booted the box
- <2016-01-07 Thu 19:16>
- Progress indicator remained on left end for a while
- <2016-01-07 Thu 19:18>
- Menu appears, chose English
- Chose "Install OS X"
- Continue
- Agree
- Agree
- Macintosh HD (42GB)
- Install
- Install sequence begins
- <2016-01-07 Thu 19:19>
  - Sometimes it says 0m remaining for the entire duration then completes.
    Other times it shows a countdown to 0 and then says "About a second
    remaining" for a long time and then says "About 0 seconds remainng" for
    a while and then completes.
- <2016-01-07 Thu 19:24>
- Reboots into another install sequence
- Progress bar again sits on the left side
- No Message for a while
- Says "Installing: About 20 minutes remainng"
- <2016-01-07 Thu 19:29>
- Fan turned on, keyboard and palm-rest warm
- 17 remaining
- <2016-01-07 Thu 19:38>
- Took the snapshot (while box is running)

***** 00001

- Perform common setup for =gcr=
  - Don't do it all though, just create the user, don't configure anything
    else
  - Because this is getting snapshotted the directions don't have to be the same
- Get updates from AppStore
  - When prompted: Turn on Auto Updates
- Restart and check for more updates
- Shutdown
...
- Note: Still need to tell OS X that it can use more hard drive space. It has a
  40GB partition and 256 is available. It takes a command to make that happen.
  That reminds me: make this 256 up in the settings.

***** TODO

- Follow common directions for installing Xcode
- Check for updates
- Shutdown
- Take a snapshot (while box is off)

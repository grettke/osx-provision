...
***** Anti Sleep
:PROPERTIES:
:ID:       org_gcr_2017-10-07_mara:A59F5331-0685-4EFC-8F63-F3843F454919
:END:
#+NAME: org_gcr_2017-10-07_mara_CC65CA4E-4725-4350-825E-7F1C8C2863AD
#+BEGIN_SRC org
,* Anti Sleep
- Prevent system sleep when lid is closed: NO
- Prevent display sleep when lid is open: NO
- Prevent system sleep when lid is open: YES
- Prevent sleep timeout: INDEFINITELY
- Status bar item click action: Open menu
- Critical battery charge action: ALWAYS ACTIVE
- Activate when AC power on: YES (but redundant here)
- Activate at launch: YES
- Open at login: YES
#+END_SRC

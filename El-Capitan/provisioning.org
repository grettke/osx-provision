...
*** Install OS X
:PROPERTIES:
:header-args: :tangle ./install-os-x.org
...
*** Configure OS X
:PROPERTIES:
:header-args: :tangle ./configure-os-x.sh :tangle-mode (identity #o755)
:ID:       46781470-E45C-4E6E-98E9-CD41507FF6FE
:END:
**** Machine
:PROPERTIES:
...
*** Install Core Operation
:PROPERTIES:
:header-args: :tangle ./install-core-operation.sh :tangle-mode (identity #o755)
:END:
***** Brew & Brew Cask
:PROPERTIES:
...
*** Configure Core Operation
:PROPERTIES:
:header-args: :tangle ./configure-core-operation.org
:END:

# [[file:provisioning.org::*Git%20Setup][B807D882-CDAB-4029-9FFE-FB967D0DB38F]]
set -x
# B807D882-CDAB-4029-9FFE-FB967D0DB38F ends here

# [[file:provisioning.org::*Git%20Setup][41FF7AA3-8273-4281-A7E8-C60B048723D4]]
rm -rf ~/.ssh
mkdir ~/.ssh
cd ~/.ssh
...
# [[file:provisioning.org::*Git%20Setup][298B36CF-28A0-45CC-BACF-787EAB06F348]]
...
# [[file:provisioning.org::*Git%20Setup][53F16E84-34DC-48D1-998C-B9214B32AD1E]]
echo .DS_Store > ~/.gitignore_global
git config --global core.excludesfile ~/.gitignore_global
# 53F16E84-34DC-48D1-998C-B9214B32AD1E ends here

# [[file:provisioning.org::*Git%20Setup][3934CA71-20AE-4136-AB57-1DEF8EBC0ADB]]
...
# [[file:provisioning.org::*Git%20Setup][70D5D9F2-6CFC-4FB5-BC45-416B4ABA029F]]
cat > ~/.ssh/config << EOF
Host github-grettke
     HostName github.com
     User git
...
# [[file:provisioning.org::*Git%20Setup][07933181-5F02-43CB-9DF8-232DA213E4BB]]
ssh -T github-grettke
read -p "Did it work? If not, fix it."
# 07933181-5F02-43CB-9DF8-232DA213E4BB ends here

# [[file:provisioning.org::*Git%20Setup][66DAC891-FB97-48A8-9C8B-0292095F13A6]]

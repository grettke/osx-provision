...
- *Start*
  - If you've got an Internet connection then access the steps online
  - Otherwise find one beforehand and download it in a ZIP file or pull it with Git
- ~Steps~ implements provisioning
  ...
  - Most of the configuration steps can be completed just in time when you use the app
  - ~SSH~: Install a copy of your =.ssh= directory before you move on from here
...
- System Preferences
  ...
  - Accessibility
    ...
    - Switch Control: *NA*
  - iCloud: *NA*
    - Should be set up but I am not using it at all
  - SwitchResX: *NA*
  - Tuxera NTFS: *NA*
...
**** cron
:PROPERTIES:
:ID:       org_gcr_2018-09-12T21-10-55-05-00_globigerina:A91CD0FF-5A46-4DE6-90F7-ACB6E9D2C970
:END:
#+name: org_gcr_2018-09-12T15-56-53-05-00_cosmicality_B0DEB0C2-6D87-4FC8-8E94-877CB64CE730
#+begin_src sh :tangle no
SHELL=/usr/local/bin/bash
BASH_ENV=$HOME/.bash_global_non_interactive
MAILTO=''
# min   hour    day     month   day-of-week command
#(0-59) (0-23)  (1-31)  (1-12)  (0-6)
#------------------------------------------------------------
,*/30       *       *       *       *           $HOME/util/announcetime >> $HOME/.out 2>&1
,*/45       7,19    *       *       *           $HOME/util/twicedaily >> $HOME/.out 2>&1
#+end_src
**** Font By Language
:PROPERTIES:
...
***** Rest
:PROPERTIES:
:ID:       org_gcr_2018-09-12T14-42-11-05-00_cosmicality:D5BAA0EC-8F76-4B61-B288-86744CE810F1
:END:
